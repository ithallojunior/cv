...
Desenvolvedor Python e mestrando em Engenharia Biomédica com formação em Engenharia Eletrônica. 
Experiência em Python com mais de 5 anos, 
...
\textbf{setembro 2019 - presente}
\begin{addmargin}{0.5cm}
Desenvolvedor pleno - Coopersystem \\
Desenvolvimento de sistemas web com Python utilizando Django e Django REST Framework.\\
\end{addmargin}
...
do ensino superior (cálculo, eletrônica digital, programação, etc.) e 
elaborando apostilas para o ensino médio.\\
\end{addmargin}
